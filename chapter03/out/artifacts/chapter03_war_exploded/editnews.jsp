...
<div id="content" class="main-content clearfix">
    ...
    <div class="main-content-right">
        <form action="${pageContext.request.contextPath}/action/updateNewsAction.jsp" method="post">
        		<p>新闻标题： <input type="text" name="title" value="习近平访美"/></p>
        		<p>
        			新闻分类：
        		...
        		<p>新闻摘要： <input type="text" name="summary"  value="国内"/></p>
        		<p>新闻内容：
        			<textarea rows="10" cols="20" name="content" class="ckeditor" >习近平访美</textarea>
        		</p>
        		<p>作者：习大大</p>
        		<input type="submit"/>
        </form>
